...
dog_spotify = BigQueryOperator(
  task_id='dog_spotify',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/dog_spotify.sql',
  write_disposition='WRITE_TRUNCATE',
  destination_dataset_table = 'umg-comm-tech-dev.fixed_playlists.dog_stats_spotify',
  dag = dag
  )

### Relaxing Dog Music stats from Spotify

dog_deezer = BigQueryOperator(
  task_id='dog_deezer',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/dog_deezer.sql',
  write_disposition='WRITE_TRUNCATE',
  destination_dataset_table = 'umg-comm-tech-dev.fixed_playlists.dog_stats_deezer',
  dag = dag
  )