...
dag = DAG('Pitched_optimize',
  description = 'Creating input for the pitched optimize application',
...
bq_2 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/ar_tpe_playlistclusters_base.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_3 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/ar_tpe_playlistclusters_base_perc.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_4 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_TrackSkipLkup.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_5 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_StreamExport.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_6 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_UserDiscCol.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_7 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_UserReturning.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_8 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_StreamBuild1a.sql',
  write_disposition='WRITE_TRUNCATE',
...
AR_TPR_StreamBuild1b = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_StreamBuild1b.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_9 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_StreamBuild3.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_10 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_StreamBuild3b.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_11 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_TPR_HeadTail_Build2.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_12 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_mean_estimates.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_13 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_stdev_estimates.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_14 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_standardized_data.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_15 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_standardized_beta_estimates.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_16 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_Slope.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_17 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_find.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_18 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_Results1.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_19 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_HeadTail_Results2.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_20 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_Streams_Final1_Days.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_21 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_Streams_Final1_Days_Stats.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_22 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_Streams_Final1_Days_stats2.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_23 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/Ar_TPR_Streams_Final1_Days_stats2_Bench.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_24 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/ar_tpr_final_data_store.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_25 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_APOLLO_DATA_load.sql',
  write_disposition='WRITE_TRUNCATE',
...
bq_26 = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_APOLLO_DATA_prod.sql',
  write_disposition='WRITE_TRUNCATE',
...
AR_APOLLO_DATA_load_comp = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_APOLLO_DATA_load_comp.sql',
write_disposition='WRITE_TRUNCATE',
...
AR_APOLLO_DATA_prod_non_umg  = BigQueryOperator(
  ...
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/AR_APOLLO_DATA_prod_non_umg.sql',
  write_disposition='WRITE_TRUNCATE',
...
fill_nulls = BashOperator(
        task_id ='fill_nulls',
        bash_command='python /home/airflow/gcs/dags/app/fill_na.py /home/airflow/gcs/data/apollo_export_{{macros.ds_format(macros.ds_add( ds, -1),\'%Y-%m-%d\',\'%Y%m%d\')}}.csv /home/airflow/gcs/data/apollo_export_{{macros.ds_format(macros.ds_add( ds, -1),\'%Y-%m-%d\',\'%Y%m%d\')}}' ,
        dag=dag
  )
...
fill_nulls_non_umg = BashOperator(
        ...
        bash_command='python /home/airflow/gcs/dags/app/fill_na.py /home/airflow/gcs/data/apollo_export_non_umg_{{macros.ds_format(macros.ds_add( ds, -1),\'%Y-%m-%d\',\'%Y%m%d\')}}.csv /home/airflow/gcs/data/apollo_export_non_umg_{{macros.ds_format(macros.ds_add( ds, -1),\'%Y-%m-%d\',\'%Y%m%d\')}}' ,
        dag=dag
  )
...
lzop_install = BashOperator(
        ...
        bash_command="sudo apt-get install lzop",
        dag = dag
)
...
check_gcs_size = BashOperator(
        ...
        bash_command="python /home/airflow/gcs/dags/app/check_gcs_size.py {{macros.ds_format(macros.ds_add( ds, -1),\'%Y-%m-%d\',\'%Y%m%d\')}}",
        dag = dag
)
