...
ON regexp_extract(w.source_uri,r'playlist:(.*)') = t.playlist_id
  AND w.isrc = t.isrc 
...
ON t.playlist_id = regexp_extract(s.source_uri,r'playlist:(.*)') AND cast(t._PARTITIONTIME as date) =s.stream_date
