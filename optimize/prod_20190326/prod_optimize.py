...
bq_05 = BigQueryOperator(
  task_id='AR_TPR_StreamExport0',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/prod_AR_TPR_StreamExport0.sql',
  write_disposition='WRITE_APPEND',
  destination_dataset_table = 'umg-comm-tech-dev.Optimize.AR_TPR_StreamExport0',
  dag = dag
    )
