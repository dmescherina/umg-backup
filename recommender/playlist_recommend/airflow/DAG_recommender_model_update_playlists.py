...
dag = DAG('recommender_model_update_playlists',
  description = 'Gathering data, model training and metadata dictionary update for playlist recommender',
  schedule_interval='0 0 5 * *', # run monthly on 6th
  max_active_runs=1,
  default_args=args)

### Gather playlists uris with more than 10 followers
get_playlists_playlists = BigQueryOperator(
  task_id='get_playlists_playlists',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/get_playlists_playlists.sql',
  write_disposition='WRITE_TRUNCATE',
  destination_dataset_table = 'umg-comm-tech-dev.recommender_playlists.all_playlists',
  dag = dag
  )

### Gather playlists uris from Apple
get_playlists_apple_playlists = BigQueryOperator(
  task_id='get_playlists_apple_playlists',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/get_playlists_apple_playlists.sql',
...
get_missing_browse_playlists_playlists = BigQueryOperator(
  task_id='get_missing_browse_playlists_playlists',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/get_missing_browse_playlists_playlists.sql',
  write_disposition='WRITE_APPEND',
  destination_dataset_table = 'umg-comm-tech-dev.recommender_playlists.all_playlists',
  dag = dag
  )
...
get_playlists_meta_playlists = BigQueryOperator(
  task_id='get_playlists_meta_playlists',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/get_playlists_meta_playlists.sql',
  write_disposition='WRITE_TRUNCATE',
  destination_dataset_table = 'umg-comm-tech-dev.recommender_playlists.model_data_with_meta',
  dag = dag
  )

get_playlists_meta_apple_playlists = BigQueryOperator(
  task_id='get_playlists_meta_apple_playlists',
  use_legacy_sql=False,
  allow_large_results=True,
  bql='/sql/get_playlists_meta_apple_playlists.sql',
  write_disposition='WRITE_APPEND',
  destination_dataset_table = 'umg-comm-tech-dev.recommender_playlists.model_data_with_meta',
  dag = dag
  )
...
model_data_to_gcs = bigquery_to_gcs.BigQueryToCloudStorageOperator(
  ...
  source_project_dataset_table='umg-comm-tech-dev.recommender_playlists.model_data_with_meta',
